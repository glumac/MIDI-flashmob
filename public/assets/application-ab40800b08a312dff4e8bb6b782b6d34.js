...
// listener function that allows color changes based on note pitch 
function listen(){
...
//changing instruments based on click of first four satie avatars
$("li:nth-child(1) img").click(function() {
	console.log("changing to sound one");
...
//removing and adding classes to change satie gravatar css when players join the mob
function red(){
...
// pre-load instrument soundfonts so no delay when play of track starts 
